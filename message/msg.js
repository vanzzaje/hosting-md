...
module.exports = async(conn, msg, m, setting, store, welcome) => {
	try {
		...
		const isOwner = ownerNumber == sender ? true : ["628988293493@s.whatsapp.net"].includes(sender) ? true : false
		...
		const cpanellogo = await getBuffer("https://getvectorlogo.com/wp-content/uploads/2019/04/powered-by-cpanel-and-whm-vector-logo.png") 
		...
		const buttonsDefault = [
		    { urlButton: { displayText: `Website`, url : `${setting.youtubeOwner}` } },
